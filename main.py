...
st.title("Bean Advocate: A Coffee Recommender")
...
aroma = st.slider("Aroma - The measure of smell such as smoky, nutty or herbal released from coffee.", 1, 10)

acidity = st.slider("Acidity - The measure of how large of a range of flavours preceived in coffee.", 1, 10)

body = st.slider("Body - The measure of physical feel of the coffee while drinking, such as heaviness or graininess.", 1, 10)

flavor = st.slider("Flavour - The overall balance of basic tastes – sweet, bitter, sour and other flavours.", 1, 10)
...
if st.button('Search Google'):
    ...
    count = 0
    c = " Coffee"
    beanb = beanb.__add__(c)
    #beanb = the name of the bean to search, number = results to display
    with st.spinner(text='one moment please.'):
